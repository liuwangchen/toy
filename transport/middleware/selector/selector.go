...
type (
	transporter func(ctx context.Context) (rpc.Transporter, bool)
	MatchFunc   func(ctx context.Context, operation string) bool
)

var (
	// serverTransporter is get server transport.Transporter from ctx
	serverTransporter transporter = func(ctx context.Context) (rpc.Transporter, bool) {
		return rpc.FromServerContext(ctx)
	}
	// clientTransporter is get client transport.Transporter from ctx
	clientTransporter transporter = func(ctx context.Context) (rpc.Transporter, bool) {
		return rpc.FromClientContext(ctx)
	}
)
...
func (b *Builder) Build() middleware.Middleware {
	var transporter func(ctx context.Context) (rpc.Transporter, bool)
	if b.client {
