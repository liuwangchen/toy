...
var (
	levelStrings = [...]string{"FNST", "FINE", "DEBG", "TRAC", "INFO", "WARN", "EROR", "FATL"}
)
...
func NewDefaultLogger(lvl level) Logger {
	return Logger{
		"stdout": &Filter{lvl, NewConsoleLogWriter(WithConsoleColor())},
	}
}
...
func (log Logger) intLogf(lvl level, format string, args ...interface{}) {
	...
	*/
	...
	_, file, lineno, ok := runtime.Caller(callerSkip)
	src := ""
	if ok {
...
func (log Logger) InfoW(content string, kv ...interface{}) {
	if len(kv)%2 == 0 {
